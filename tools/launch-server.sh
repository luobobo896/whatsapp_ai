...
export INTERNAL_API_TOKEN="$($python_bin -c 'import json, os; print(json.load(open(os.path.expanduser("~/.openclaw/openclaw.json")))["mcp"]["servers"]["whatsapp-rag"]["env"]["INTERNAL_API_TOKEN"])')"
